...
makeGroen <- function(csvfile, fractions, rep, i) {
...
## Read marker file
y <- read.csv("../extdata/Groen_MarkerList.csv.gz", row.names=1)
mrk <- as.character(y[,1])
names(mrk) <- rownames(y)
## Expt 1
f <- c("2/4", "2/6", "2/8-10", "4/6", "4/8-10", "6/8-10")
groen2014r1 <- makeGroen("../extdata/Groen_Supplemental_Table3a.csv.gz", f, "r1", 1)
groen2014r1 <- addMarkers(groen2014r1, mrk, verbose=FALSE)
## Expt 2A
f <- c("2/4", "2/6", "2/8-11", "4/6", "4/8-11", "6/8-11")
groen2014r2 <- makeGroen("../extdata/Groen_Supplemental_Table3b.csv.gz", f, "r2", 2)
groen2014r2 <- addMarkers(groen2014r2, mrk, verbose=FALSE)
## Expt 2B
f <- c("3/4", "3/5", "3/7", "4/5", "4/7", "5/7")
groen2014r3 <- makeGroen("../extdata/Groen_Supplemental_Table3c.csv.gz", f, "r3", 3)
