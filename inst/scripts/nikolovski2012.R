...
f1 <- "../extdata/Nikolovski2012_SupplTable1.csv.gz"
nikolovski2012 <- makeSet(f1)
featureNames(nikolovski2012) <- fData(nikolovski2012)$Protein.ID


f2 <- "../extdata/Nikolovski2012_SupplTable2.csv.gz"
...
fData(nikolovski2012imp)$preds <-
    fData(nikolovski2012imp)$"Localization.assigned.by.the.Naive.Bayesian.classifier_start.below.threshold."
nikolovski2012imp@experimentData@other$prediction.fcol <- "preds"
...
stopifnot(pRolocdata:::valid.pRolocmetadata(pRolocmetadata(nikolovski2012)))
stopifnot(pRolocdata:::valid.pRolocmetadata(pRolocmetadata(nikolovski2012imp)))
